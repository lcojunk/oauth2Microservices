...
//@Service
@RestController
@RequestMapping(value = {"/api/technics", "/${spring.application.name}" + "/api/technics", "oauth2_create" + "/api/technics"})
public class RestCrudTechController implements RestCrudInterface<EntityResponseDTO, Long, EntityRequestDTO> {

    @Autowired
    private CrudTechMySQLService repository;
