...
//@Service
@RestController
@RequestMapping(value = {"/api/branches", "/${spring.application.name}" + "/api/branches", "oauth2_create" + "/api/branches"})
public class RestCrudBranchController implements RestCrudInterface<EntityResponseDTO, Long, EntityRequestDTO> {
