...
//@Service
@RestController
@RequestMapping(value = {"/api/lobs", "/${spring.application.name}" + "/api/lobs", "oauth2_search" + "/api/lobs"})
public class RestCrudLobController implements RestCrudInterface<EntityResponseDTO, String, EntityRequestDTO> {

    @Autowired
    private CrudLobElasticLService repository;
